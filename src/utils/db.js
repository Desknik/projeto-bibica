...
async function createInitialTelefone(){

  const InitialTelefone = await prisma.telefone.findFirst({where: {id:1}})
...
export {createInitialClassUsers, createInitialSituations, createInitialuser, createInitialTelefone};
